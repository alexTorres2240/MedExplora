...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, sendError, getResponseStatusText } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/@vue/shared/dist/shared.cjs.js';
import { promises, readFileSync, existsSync, mkdirSync, writeFileSync } from 'node:fs';
import bcrypt from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/bcryptjs/index.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/vue/index.mjs';
import { createHooks } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/errx/dist/index.js';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt/nuxt-icon-server-bundle.mjs';
import { walkResolver } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/public"
      ]
    },
    "http": {
      "domains": []
...
const _45RKMcOaOS9Bu1Rq6Oz8f44KXYmpNy4xlA6IWJsvqI = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG";
...
const _HbeFPV2yPNROBUNtCXJEjzNFTA_uxwIGo32Tgqdn54 = (nitroApp) => {
...
const _M406IoMMMnXACiJ_PBRzvh60v8TndThpjBJsOIiYLA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const plugins = [
  _45RKMcOaOS9Bu1Rq6Oz8f44KXYmpNy4xlA6IWJsvqI,
_HbeFPV2yPNROBUNtCXJEjzNFTA_uxwIGo32Tgqdn54,
_M406IoMMMnXACiJ_PBRzvh60v8TndThpjBJsOIiYLA
];
...
const _PPrHV2 = eventHandler((event) => {
...
const _L0LxLR = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _1_VsJz = eventHandler(async (event) => {
  ...
  return await import('file://C:/Users/HP/Documents/IngenieriaDeSoftware/medExploraOG/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _lnSt0Y = eventHandler(async (event) => {
...
const _o7WBU5 = lazyEventHandler(() => {
...
const _lazy_TOrGhy = () => Promise.resolve().then(function () { return check_get$1; });
const _lazy_go4YbQ = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_NxLKXj = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_292yHP = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _PPrHV2, lazy: false, middleware: true, method: undefined },
  { route: '/api/users/check', handler: _lazy_TOrGhy, lazy: true, middleware: false, method: "get" },
  { route: '/api/users/login', handler: _lazy_go4YbQ, lazy: true, middleware: false, method: "post" },
  { route: '/api/users/register', handler: _lazy_NxLKXj, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_292yHP, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _L0LxLR, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _1_VsJz, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _lnSt0Y, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _o7WBU5, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_292yHP, lazy: true, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_292yHP, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_292yHP, lazy: true, middleware: false, method: undefined }
];
...
const DATA_FILE$2 = join(process.cwd(), "data", "users.json");
function ensureDataFile$1() {
  const dir = join(process.cwd(), "data");
  if (!existsSync(dir)) mkdirSync(dir);
  if (!existsSync(DATA_FILE$2)) writeFileSync(DATA_FILE$2, JSON.stringify({}), "utf-8");
}
function loadUsers$2() {
  ensureDataFile$1();
  return JSON.parse(readFileSync(DATA_FILE$2, "utf-8") || "{}");
}
const check_get = defineEventHandler((event) => {
  const q = getQuery$1(event);
  const email = (q.email || "").toLowerCase();
  if (!email) return { exists: false };
  const users = loadUsers$2();
...
const DATA_FILE$1 = join(process.cwd(), "data", "users.json");
function loadUsers$1() {
  if (!existsSync(DATA_FILE$1)) return {};
  return JSON.parse(readFileSync(DATA_FILE$1, "utf-8") || "{}");
}
const login_post = defineEventHandler(async (event) => {
  try {
    ...
    const users = loadUsers$1();
    const user = users[email];
    if (!user) return sendError(event, createError({ statusCode: 401, statusMessage: "Usuario no registrado" }));
    const ok = bcrypt.compareSync(password, user.passwordHash);
    if (!ok) return sendError(event, createError({ statusCode: 401, statusMessage: "Credenciales inv\xE1lidas" }));
...
const register_post = defineEventHandler(async (event) => {
  try {
    ...
    if (!hash) {
      return sendError(event, createError({ statusCode: 400, statusMessage: "No se proporcion\xF3 hash/contrase\xF1a" }));
    }
    users[email] = {
      passwordHash: hash,
      nombre: body.nombre || "",

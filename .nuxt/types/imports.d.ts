...
declare global {
  ...
  const hashPassword: typeof import('../../app/utils/security')['hashPassword']
  ...
  const loadAllowedDomains: typeof import('../../app/utils/security')['loadAllowedDomains']
  ...
  const validateInstitutionalEmail: typeof import('../../app/utils/security')['validateInstitutionalEmail']
  const validatePasswordStrength: typeof import('../../app/utils/security')['validatePasswordStrength']
  const verifyPassword: typeof import('../../app/utils/security')['verifyPassword']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly hashPassword: UnwrapRef<typeof import('../../app/utils/security')['hashPassword']>
    ...
    readonly loadAllowedDomains: UnwrapRef<typeof import('../../app/utils/security')['loadAllowedDomains']>
    ...
    readonly validateInstitutionalEmail: UnwrapRef<typeof import('../../app/utils/security')['validateInstitutionalEmail']>
    readonly validatePasswordStrength: UnwrapRef<typeof import('../../app/utils/security')['validatePasswordStrength']>
    readonly verifyPassword: UnwrapRef<typeof import('../../app/utils/security')['verifyPassword']>

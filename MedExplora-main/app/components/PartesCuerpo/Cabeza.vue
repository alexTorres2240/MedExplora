...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Cabeza</h1>
    <img src="/imagenes/cuerpo/cabezaFren.png" alt="Cabeza" class="cuerpo" />
  </div>
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vRPbLnB67BxSEtcCnrtUbVg-oqBbQt5ajE8DKwWb4e0ub84UnqJjTyQLRXuuAmgjBmQuGewCStlqS6x/pub');

...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Espalda</h1>
    <img src="/imagenes/cuerpo/espalda.png" alt="Espalda" class="cuerpo" />
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vT0oSOxxZZQsY6pU9MVAZiIfLt5BVemgFnoRTcG5AoiNa0sYzrvqjSsde4q7dYj45D6cXp9qoaXLYyg/pub');

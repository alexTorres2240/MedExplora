...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Pierna Derecha</h1>
    <img src="/imagenes/cuerpo/piernaDer.png" alt="Pierna Derecha" class="cuerpo" />
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vS-xyrT8WgmckfDYI7wp1cwMNpdx3rNxQPovttCs4fX6im2QiPg-gaC6IQLZSlisAZ8-IpmyNZt01GF/pub');

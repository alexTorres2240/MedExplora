...
.viewer {
  position: fixed;
  top: 25px;
  left: 270px; /* deja espacio para el panel */
...
.viewer.menu-abierto {
  left: 155px; /* se mueve hacia la derecha */
}
...
.info-panel {
  position: fixed;
  top: 45px; /* justo debajo de la barra superior */
  left: 0;
  width: 500px;
  height: calc(100vh - 45px);
  background: #024731; /* verde oscuro translúcido */
  color: #fff;
  padding: 25px 20px;

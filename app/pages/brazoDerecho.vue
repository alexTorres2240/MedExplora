...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Brazo Derecho</h1>
    <img src="/imagenes/cuerpo/brazoDer.png" alt="Brazo Derecho" class="cuerpo" />
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vSvdH8AZXpVEFeXpNAV6WR_sCErRdhq_BuJQL3fd3o9wglpy83mqmYgJEMZ-dCveK2BNE6egEcFocFD/pub');

...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Pierna Izquierda</h1>
    <img src="/imagenes/cuerpo/piernaIzq.png" alt="Pierna Izquierda" class="cuerpo" />
  </div>
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vRY0QBDi12q_ux-pU-CE4fKsxZZ60L2XYHrA1VpAnNod845dBKIMV8xiSHvyqfpgiDCrRx3be6iHicg/pub');

...
<div class="cuerpo-container">
  ...
  <div class="contenido-central">
    <h1 class="titulo">Torso</h1>
    <img src="/imagenes/cuerpo/torso.png" alt="Torso" class="cuerpo" />
  </div>
...
onMounted(async () => {
  const res = await fetch('https://docs.google.com/document/d/e/2PACX-1vTNTOe13Zvb3bvcF5i_d30bvJDvM4se4PimLNXmMoVNg_kyLIAunnWp6c7k7D4xXVB55cSDiRpkRaCA/pub');
